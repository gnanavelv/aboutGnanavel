...
class App extends Component {
  ...
  <div className="row main-row">
     <div className="col-lg-8 col-lg-2">
      ...
      <p className="linkedin-text">Visit my <a href="https://linkedin.com/in/gnanavelv27" rel="noopener noreferrer" target="_blank">Linkedin</a> profile. If you add me don't expect an instant response, I don't usually check it.</p>
      <p className="resume-text">Lastly, my last updated <a target="_blank" href={Resume} rel="noopener noreferrer">resume</a> (February 2019).</p>
